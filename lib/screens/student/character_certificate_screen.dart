...
class CharacterCertificateScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            tooltip: 'View / Save / Share Certificate',
          ),
        ],
      ),
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                icon: const Icon(Icons.image_outlined),
                label: const Text('View / Save Certificate Image'),
                onPressed: () => _openCertificate(context),
  ...
  Future<void> _openCertificate(BuildContext context) async {
    await openCertificatePreview(
      ...
      fileName: 'CharacterCert_${cert.erpId}',
      certificate: certw.buildCharacterCertCertificate(cert),
    );
  }
}
